 ...
 *
 * Previously, all metadata writers (EXIF, IPTC, XMP) swallowed exceptions to stderr, producing
 * valid-but-wrong files with no failure signal. This exception propagates write failures so callers
