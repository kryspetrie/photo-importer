...
data class BoundingBoxList(val boxes: List<BoundingBox> = emptyList()) {
    ...
    /**
     * Finds the box at the given point (within the hit buffer radius). Returns null if no box is
     * hit.
     */
    ...
    /**
     * Finds the corner of any box at the given point (within the hit buffer radius). Returns the
     * box and corner if found, null otherwise.
     */
