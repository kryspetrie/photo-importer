...
data class BoundingBoxCorners(
    ...
    /**
     * Checks if this shape would create an invalid (self-intersecting/bowtie) quadrilateral. A
     * valid quadrilateral has edges that don't cross each other.
     */
...
data class BoundingBox(
    ...
    companion object {
        fun createRectangular(center: Point, width: Double, height: Double): BoundingBox {
            return BoundingBox(
                corners = BoundingBoxCorners.fromCenter(center.x, center.y, width, height)
            )
        }
        ...
        fun createRectangular(
            ...
            return BoundingBox(
                corners = BoundingBoxCorners.fromCenter(centerX, centerY, width, height)
            )
        }
        ...
        /**
         * Creates a rectangular bounding box from two diagonal corners. The corners are
         * automatically ordered as top-left, top-right, bottom-right, bottom-left.
         */
