...
data class ZoomController(
  ...
  /**
   * Returns a new controller with the specified zoom level. If cursor position is provided, zoom is
   * applied around that point.
   */
  ...
  companion object {
    ...
    fun fit(
      ...
      return ZoomController().fitToView(imageWidth, imageHeight, viewportWidth, viewportHeight)
    }
  }
}
