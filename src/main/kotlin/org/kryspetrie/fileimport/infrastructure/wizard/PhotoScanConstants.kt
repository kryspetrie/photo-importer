...
object PhotoScanConstants {
   ...
   *
   * When creating a box by clicking (e.g., "Add Box" mode), the box will be
   * 30% of the image width by default.
   */
   ...
   *
   * This is a conservative estimate for high-resolution exports.
   * Used for disk space validation before export.
   */
   ...
   *
   * Images larger than this will be downsampled for preview display.
   * The full resolution is still used for export.
   */
