 ...
 *
 * Tracks the complete journey of each file through the import process,
 * including source, destination, naming patterns applied, and verification status.
 */
@Serializable
 ...
 *
 * Contains both summary statistics and detailed per-file information
 * for comprehensive import tracking and auditing.
 */
@Serializable
