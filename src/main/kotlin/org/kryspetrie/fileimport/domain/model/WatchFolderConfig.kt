 ...
 *
 * Each config represents a single watch folder with its own source path, destination,
 * import settings, and scheduling options. Configs are persisted in [AppSettings] and
 ...
 * @property enabled Whether this watch config is active. Disabled configs are paused but not deleted.
