 ...
 *
 * @property orientationDegrees How much the image is rotated **clockwise from upright**
 *   (0°–359.9°). For example, if the image was turned 90° clockwise, this value will be near 90°.
 ...
 *   orientation. This is the model's raw output (normalized to [0, 360)). For example, if the image
 *   is oriented 90° CW from upright, this value will be near 270° (rotate 270° CW = 90° CCW to make
 *   it upright).
 */
