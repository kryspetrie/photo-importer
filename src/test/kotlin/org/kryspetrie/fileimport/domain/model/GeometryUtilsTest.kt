...
class GeometryUtilsTest {
    ...
    inner class ApplyMarginTests {
        ...
        fun `returns same photo when margin is zero`() {
            val original = photo(10f to 10f, 90f to 10f, 90f to 90f, 10f to 90f)
        ...
        fun `expands corners outward from center`() {
            val original = photo(40f to 40f, 60f to 40f, 60f to 60f, 40f to 60f)
            ...
            val origDist =
                GeometryUtils.distance(40.0 to 40.0, origCx.toDouble() to origCy.toDouble())
            val resultDist =
        ...
        fun `preserves approximate aspect ratio after margin expansion`() {
            val original = photo(30f to 20f, 70f to 20f, 70f to 80f, 30f to 80f)
        ...
        fun `positive margin expands all corners`() {
            val original = photo(100f to 100f, 200f to 100f, 200f to 200f, 100f to 200f)
            val result = GeometryUtils.applyMargin(original, 0.05)
