...
/**
 * Component tests for SummaryScreen.
 * Tests UI rendering and export configuration.
 * 
...
class SummaryScreenTest {
    ...
    fun shouldDisplayTitle() {
        ...
        composeTestRule.onNodeWithText("Photo Summary")
            .assertIsDisplayed()
    }
    ...
    fun shouldDisplayPhotoCount() {
        ...
        composeTestRule.onNodeWithText("1 photo(s)")
            .assertIsDisplayed()
    }
    ...
    fun shouldDisplayExportDestination() {
        ...
        composeTestRule.onNodeWithText("/test/output")
            .assertIsDisplayed()
    }
