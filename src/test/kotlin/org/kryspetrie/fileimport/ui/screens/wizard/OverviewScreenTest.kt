...
/**
 * Component tests for OverviewScreen.
 * Tests UI rendering and user interactions with state changes.
 * 
...
class OverviewScreenTest {
    ...
    fun shouldDisplayTitle() {
        ...
        composeTestRule.onNodeWithText("Bounding Box Overview")
            .assertIsDisplayed()
    }
    ...
    fun shouldDisplay4PointButton() {
        ...
        composeTestRule.onNodeWithText("4-Point")
            .assertIsDisplayed()
    }
    ...
    fun shouldDisplayAddBoxButton() {
        ...
        composeTestRule.onNodeWithText("Add Box")
            .assertIsDisplayed()
    }
    ...
    fun shouldDisplayToSummaryButton() {
        ...
        composeTestRule.onNodeWithText("To Summary")
            .assertIsDisplayed()
    }
    ...
    fun shouldDisplayHelpButton() {
        ...
        composeTestRule.onNodeWithContentDescription("Help")
            .assertIsDisplayed()
    }
    ...
    fun shouldOpenHelpDialogWhenHelpClicked() {
        ...
        composeTestRule.onNodeWithText("Keyboard Shortcuts")
            .assertIsDisplayed()
    }
    ...
    fun shouldShowZeroBoxesInitially() {
        ...
        composeTestRule.onNodeWithText("0 box(es)")
            .assertIsDisplayed()
    }
    ...
    fun shouldShowAddBoxModeIndicatorWhenClicked() {
        ...
        composeTestRule.onNodeWithText("Add Box Mode")
            .assertIsDisplayed()
    }
}
