...
/**
 * Component tests for RefinementScreen.
 * Tests UI rendering and user interactions for box refinement.
 * 
...
class RefinementScreenTest {
    ...
    fun shouldDisplayTitle() {
        ...
        composeTestRule.onNodeWithText("Refine Bounding Box")
            .assertIsDisplayed()
    }
    ...
    fun shouldDisplayPerspectiveToggle() {
        ...
        composeTestRule.onNodeWithText("Perspective Correction")
            .assertIsDisplayed()
    }
    ...
    fun shouldDisplayRotationControls() {
        ...
        composeTestRule.onNodeWithText("Rotation")
            .assertIsDisplayed()
    }
