...
class RefinementScreenCoordTest {
    ...
    fun shouldCreateSampledImageAtCorrectSize() {
        val image =
            java.awt.image.BufferedImage(800, 600, java.awt.image.BufferedImage.TYPE_INT_RGB)
        val scale = 0.5
    ...
    fun shouldClampMinimumSize() {
        val image =
            java.awt.image.BufferedImage(100, 100, java.awt.image.BufferedImage.TYPE_INT_RGB)
        val scale = 0.1
