...
class ImageRepositoryAdapterTest {
  ...
  @BeforeEach
  fun setup() {
    adapter = ImageRepositoryAdapter()
  }
  ...
  inner class ScanDirectory {
    ...
    fun shouldFindImageFiles() = runTest {
      ...
      assertThat(files.map { it.fileName }).containsExactlyInAnyOrder("photo1.jpg", "photo2.png")
    }
    ...
    fun shouldAssociateSidecars() = runTest {
      ...
      assertThat(rawFile.sidecars.map { it.extension }).containsExactlyInAnyOrder("xmp", "thm")
    }
