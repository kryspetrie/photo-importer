...
class BoundingBoxTest {
  ...
  fun createQuadrilateralBoxFrom4Points() {
    val points = listOf(Point(10.0, 10.0), Point(90.0, 10.0), Point(90.0, 90.0), Point(10.0, 90.0))
  ...
  fun aspectRatioCalculationForLandscapeBox() {
    val box =
        BoundingBox.createRectangular(
            center = Point(100.0, 100.0), width = 100.0, height = 60.0 // landscape
            )
  ...
  fun aspectRatioCalculationForPortraitBox() {
    val box =
        BoundingBox.createRectangular(
            center = Point(100.0, 100.0), width = 60.0, height = 100.0 // portrait
            )
  ...
  fun squareDetectionForNearlySquareBox() {
    val box =
        BoundingBox.createRectangular(
            center = Point(100.0, 100.0), width = 100.0, height = 98.0 // within threshold
            )
